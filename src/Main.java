...
public class Main {
    public static void main(String[] args) {
        ...
        //UC7:  Adding contacts
        addressBook.addContact(new Contact("Joe", "Doe", "765 Elm St", "Springfield", "IL", "62701", "1234567890", "john.doe@example.com"));
        addressBook.addContact(new Contact("Kane", "Smith", "123 Maple St", "Springfield", "IL", "62701", "0987654321", "jane.smith@example.com"));
        addressBook.addContact(new Contact("Ron", "Doe", "498 Oak St", "Springfield", "IL", "62702", "1112223333", "duplicate.john@example.com"));
        ...
        List<Contact> search_Results = addressBook.searchByCityOrState("Springfield");
